...
func CreateMultiFunctionPCIHostDevices(hostDevicesData []HostDeviceMetaData, multiFunctionPciAddrPool AddressPooler, getPCIDeviceToFunctions func() (map[string][]string, error)) ([]api.HostDevice, error) {
